...
#define RST_BNO_Pin GPIO_PIN_11
#define RST_BNO_GPIO_Port GPIOA
#define CS_BNO_Pin GPIO_PIN_12
#define CS_BNO_GPIO_Port GPIOA
#define EXTI_BNO_Pin GPIO_PIN_15
#define EXTI_BNO_GPIO_Port GPIOA
#define EXTI_BNO_EXTI_IRQn EXTI15_10_IRQn
